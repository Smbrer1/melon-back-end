...
from back_end.schemas.message_schema import SentMessage, MessageOut, MessageDelete
...
async def delete_message(msg: MessageDelete, user=Depends(get_current_user)):
    try:
